   ...
   {/* Pagination */}
    <div className="mt-6">
      <div className="flex-wrap justify-between space-x-4 md:space-x-8 lg:space-x-96">
        ...
        {/* Pagination Next */}
        <Link to="/Nextpaginate" className="relative inline-flex items-center rounded-r-md px-2 py-2 text-xs md:text-sm ring-1 ring-inset ring-red-300 hover:bg-red-500 hover:text-white transition-colors cursor-pointer">
        Next
