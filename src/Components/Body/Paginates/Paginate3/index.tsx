...
interface MainProps {
  ...
  const Paginate3: React.FC<MainProps> = ({mytitle1,title1,image4,description1,
   ...
   {/* Pagination */}
    <div className="mt-6">
      ...
      <nav className="isolate inline-flex rounded-md shadow-sm" aria-label="Pagination">
          ...
          <a href="#" className="relative z-10 inline-flex items-center px-2 py-2 hover:bg-red-500 hover:text-white transition-colors cursor-pointer">2</a>  
          <Link to="/Paginate3" className="relative z-10 inline-flex items-center bg-red-600  px-2 py-2 hover:bg-red-500 hover:text-white transition-colors cursor-pointer">3</Link>
