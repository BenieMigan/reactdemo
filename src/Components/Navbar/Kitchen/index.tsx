...
const Kitchen: React.FC<MainProps> = ({mytitle,title,image, description,mytitle1,title1,image1,image4,description1,
    ...
    <div>
      <div className="navba-container">
        ...
        <div className='navba-1'>
          <h1>Kitchen</h1>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Et, ducimus! Qui, tempore adipisci eaque laudantium ad eveniet distinctio corrupti in aliquam. <br />Nostrum laboriosam at voluptate eum quos voluptatum sit unde.</p>
        </div>
      </div>
